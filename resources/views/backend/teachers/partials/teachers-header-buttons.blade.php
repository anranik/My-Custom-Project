<!--Action Button-->
@if( Active::checkUriPattern( 'admin/teachers' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.teachers.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.teachers.all' ) }}
            </a>
        </li>
        @permission( 'create-teacher' )
            <li>
                <a href="{{ route( 'admin.teachers.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.teachers.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
