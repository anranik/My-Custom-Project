...
@section('page-header')
    <h1>{{ trans('labels.backend.teachers.management') }}</h1>
@endsection

@section('content')
    <div class="box box-info">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.backend.teachers.management') }}</h3>
        ...
        <div class="box-body">
            <div class="table-responsive data-table-wrapper">
                <table id="teachers-table" class="table table-condensed table-hover table-bordered">
                    <thead>
                        <tr>
...
@section('after-scripts')
    ...
    <script>
        ...
        $(function() {
            var dataTable = $('#teachers-table').dataTable({
                processing: true,
                serverSide: true,
                ajax: {
