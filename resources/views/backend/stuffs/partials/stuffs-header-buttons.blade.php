<!--Action Button-->
@if( Active::checkUriPattern( 'admin/stuffs' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.stuffs.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.stuffs.all' ) }}
            </a>
        </li>
        @permission( 'create-stuff' )
            <li>
                <a href="{{ route( 'admin.stuffs.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.stuffs.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
