<!--Action Button-->
@if( Active::checkUriPattern( 'admin/guardians' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.guardians.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.guardians.all' ) }}
            </a>
        </li>
        @permission( 'create-guardian' )
            <li>
                <a href="{{ route( 'admin.guardians.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.guardians.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
