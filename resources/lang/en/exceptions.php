...
return [
	...
	"guardians" => [
	"already_exists" => "That Guardian already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this Guardian. Please try again.",
	"delete_error" => "There was a problem deleting this Guardian. Please try again.",
	"not_found" => "That Guardian does not exist.",
	"update_error" => "There was a problem updating this Guardian. Please try again.",
	],
	"teachers" => [
